package br.com.ProjetoAtividade.util;
...
public class AcessoSSH {
	...
	public static final int CHANEL_TIMEOUT = 10000;
		...
		String comando = "python3 /home/senac/Python/bancodbMysql.py";
		...
		try {
			...
			while(true) {
				...
				Process pr = Runtime.getRuntime().exec("C:\\Program Files\\Google\\Chrome\\Application//chrome http://127.0.0.1:8084/dep_sts.html");
